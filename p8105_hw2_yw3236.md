...
``` r
prec_17 =
  readxl::read_excel("./HealthyHarborWaterWheelTotals2018-7-28.xlsx", sheet = 3, range = cellranger::cell_cols("A:B")) %>% 
  janitor::clean_names() 
...
```
    ...
    ##    <int>   <dbl> <chr>    <dbl> <chr> 
    ##  1     1    2.34 2016      0.96 2017  
    ##  2     2    1.46 2016      5.3  2017  
    ##  3     3    3.57 2016      2.18 2017  
    ##  4     4    3.99 2016      3.2  2017  
    ##  5     5    5.64 2016      9.27 2017  
    ##  6     6    1.4  2016      0.2  2017  
    ##  7     7    7.09 2016      2.39 2017  
    ##  8     8    4.44 2016     NA    <NA>  
    ##  9     9    1.95 2016     NA    <NA>  
    ## 10    10    0    2016     NA    <NA>  
    ## 11    11    0.11 2016     NA    <NA>  
    ## 12    12    0.94 2016     NA    <NA>  
    ## 13    NA   32.9  2016     23.5  2017
...
There are 8 observations in 2017 precipitation dataset. There are 13 observations in 2016 precipitation dataset. The key variable is `total`, which precipitation total for each month. The total precipitation in 2017 is 23.5. The median number of sports balls in a dumpster in 2016 is 26.
